...
const Navbar = ({
  ...
  return (
    <>
      <div className="flex w-[100%] flex-row justify-between items-center m-auto px-36 py-5 min-h-[100px] fixed bg-gradient-to-b from-black/50 to-black/0 z-[40] font-bold">
